    ...
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.content}>
          ...
          itaque vitae! Assumenda soluta explicabo architecto veniam
          repudiandae! Beatae sequi optio saepe ipsam inventore nemo
          voluptatibus quidem enim quasi dicta.
        </div>
      </div>
    </div>
  );
